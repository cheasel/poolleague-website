...
export default async function EditVenuePage({ params }: PageProps) {
  ...
  if (!venue) {
    return <div className="p-20 text-center font-black text-zinc-500 uppercase">Arena Node Missing.</div>;
  }
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-10 pb-24 px-4 text-zinc-200 antialiased">
      ...
      <header className="flex items-center justify-between">
        <Link href="/admin/venues" className="flex items-center gap-2 text-[10px] font-black text-zinc-500 uppercase tracking-widest hover:text-indigo-400 transition-colors">
        ...
        <div className="p-6 md:p-10">
          ...
          <form action={updateVenue} className="space-y-6">
            ...
            <div className="space-y-2.5">
              <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400 ml-1">Host Venue / Club Title</label>
              <input 
                type="text" 
                name="name" 
            ...
            <div className="space-y-2.5">
              <div className="flex items-center gap-1.5 ml-1">
                ...
                <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400">Physical Address Coordinates</label>
              </div>
              <input 
                type="text" 
                name="address" 
            ...
            <div className="space-y-2.5">
              <div className="flex items-center gap-1.5 ml-1">
                ...
                <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400">Match Scheduler Availability Status</label>
              </div>
            ...
            <div className="pt-4 flex justify-end">
              <button type="submit" className="w-full sm:w-auto px-8 py-4 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-black uppercase tracking-widest text-xs flex items-center gap-2.5 transition-all">
      ...
      <div className="bg-zinc-900/40 backdrop-blur-md rounded-[2rem] border border-zinc-800/80 shadow-2xl p-6 md:p-10 overflow-hidden">
        ...
        {localHomeTeams.length > 0 ? (
          ...
          <div className="text-center py-10 text-xs font-bold text-zinc-600 uppercase border border-dashed border-zinc-800 rounded-xl bg-zinc-950/10">
