      ...
      <form action={formAction} className="space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-black uppercase tracking-wider text-slate-400 ml-1 flex items-center gap-1.5">
            <ImageIcon className="w-3 h-3 text-slate-500" /> Player Profile Avatar Photo
          </label>
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-black uppercase tracking-wider text-slate-400 ml-1 flex items-center gap-1.5">
            <User className="w-3 h-3 text-slate-500" /> Full Registered Name
          </label>
          <input
            type="text"
            name="name"
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            >
              ...
              {teamsList.map((team) => (
                <option key={team.id} value={team.id} className="text-slate-100 bg-slate-950">
                  {team.name}
                </option>
              ))}
            </select>
