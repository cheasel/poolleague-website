  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4">
      <div className="bg-slate-900/60 backdrop-blur-md rounded-3xl p-8 md:p-12 border border-slate-800 max-w-md w-full text-center space-y-6 shadow-2xl">
        ...
        <div>
          <h2 className="text-xl font-black uppercase tracking-tight text-white mb-2">Profile Unavailable</h2>
          <p className="text-sm text-slate-400">
            We couldn&apos;t load this player profile. This might be a temporary connection issue.
          </p>
        </div>
